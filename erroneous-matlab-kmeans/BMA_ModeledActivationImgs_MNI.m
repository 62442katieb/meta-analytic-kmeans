function ExpImg = BMA_ModeledActivationImgs_MNI(theexps)
...
testmat = 91*109*91;
[i(:,1), i(:,2), i(:,3)] = ind2sub([91 109 91], 1:testmat);
clear testmat
i = i-0.5;

for a = 1:numel(theexps)
    tempmatrix = theexps(a).XYZ_MNI;
    ...
    finalp = max(p, [], 1);
    clear p
    ExpImg(a).ModActs = reshape(finalp, [91 109 91]);
    clear finalp
end
